...
public class SauceDemoTests extends BaseTestConfig implements ConstantsSauceDemo {
    ...
    public void testCheckoutHappyPath() {
        ...
        DriverContainer.getDriver().navigate().to(SIGN_IN_PAGE_URL);
        SignInPage signInPage = new SignInPage(DriverContainer.getDriver());
        ProductsPage productsPage = signInPage.signIn(testUser);
        productsPage.addToCart(DriverContainer.getDriver(), ADDING_TO_CART_SAUCE_LABS_BACKPACK);
        ShoppingCartBadge shoppingCartBadge = new ShoppingCartBadge(DriverContainer.getDriver());
        ...
        softAssert.assertEquals(checkoutPages.findElementTextById(DriverContainer.getDriver(), "item_4_title_link"),
                SAUCE_LABS_BACKPACK,
        ...
        softAssert.assertEquals(Integer.parseInt
                        (checkoutPages.findElementTextByCssSelector(DriverContainer.getDriver(), FINDING_QUANTITY_OF_SINGLE_PRODUCT_IN_CART)),
                1, "The quantity of the product is displayed incorrectly on Checkout page! Should be 1.");
        softAssert.assertEquals(checkoutPages.findElementTextByClassName(DriverContainer.getDriver(), FINDING_PRICE_OF_SINGLE_PRODUCT_IN_CART),
        ...
        softAssert.assertEquals(checkoutPages.findElementTextByCssSelector(DriverContainer.getDriver(), "div.summary_info > div:nth-child(1)"),
                "Payment Information",
                "Payment Information summary info label is not displayed on Checkout page!");
        softAssert.assertEquals(checkoutPages.findElementTextByCssSelector(DriverContainer.getDriver(), "div.summary_info > div:nth-child(2)"),
                "SauceCard #31337",
                "Payment Information summary value label: 'SauceCard #31337' is not displayed on Checkout page!");
        softAssert.assertEquals(checkoutPages.findElementTextByCssSelector(DriverContainer.getDriver(), "div.summary_info > div:nth-child(3)"),
                "Shipping Information",
                "Shipping Information summary info label is not displayed on Checkout page!");
        softAssert.assertEquals(checkoutPages.findElementTextByCssSelector(DriverContainer.getDriver(), "div.summary_info > div:nth-child(4)"),
                "Free Pony Express Delivery!",
                "Shipping Information summary value label: 'Free Pony Express Delivery!' is not displayed on Checkout page!");
        softAssert.assertEquals(checkoutPages.findElementTextByCssSelector(DriverContainer.getDriver(), "div.summary_info > div:nth-child(5)"),
                "Price Total",
                "Price Total summary info label is not displayed on Checkout page!");
        softAssert.assertEquals(checkoutPages.findElementTextByClassName(DriverContainer.getDriver(), "summary_subtotal_label"),
        ...
        softAssert.assertEquals(checkoutPages.findElementTextByClassName(DriverContainer.getDriver(), "summary_tax_label"),
                "Tax: $2.40",
                "The Tax is displayed incorrectly on Checkout page! Should be 'Tax: $2.40'");
        softAssert.assertEquals(checkoutPages.findElementTextByCssSelector(DriverContainer.getDriver(), ".summary_info_label.summary_total_label"),
                "Total: $32.39",
                "The total price is displayed incorrectly on Checkout page! Should be 'Total: $32.39'");

        checkoutPages.finishCheckout();
        softAssert.assertEquals(checkoutPages.findElementTextByCssSelector(DriverContainer.getDriver(), "#back-to-products"),
                "Back Home",
                "Back Home button text is not displayed on Checkout:Complete! page!");
        softAssert.assertEquals(checkoutPages.findElementTextByClassName(DriverContainer.getDriver(), "complete-text"),
                "Your order has been dispatched, and will arrive just as fast as the pony can get there!",
                "Complete-text is not displayed on Checkout:Complete! page!");
        softAssert.assertEquals(checkoutPages.findElementTextByClassName(DriverContainer.getDriver(), "complete-header"),
    ...
    public void testAddingToAndRemovingProductFromCartOnInventoryDetailsPage(){
        ...
        SignInPage signInPage = new SignInPage(DriverContainer.getDriver());
        ProductsPage productsPage = signInPage.signIn(testUser);
        productsPage.openInventoryItem(DriverContainer.getDriver(), SAUCE_LABS_BACKPACK);
        productsPage.addToCart(DriverContainer.getDriver(), ADDING_TO_CART_SAUCE_LABS_BACKPACK);
        ShoppingCartBadge shoppingCartBadge = new ShoppingCartBadge(DriverContainer.getDriver());
        SoftAssert softAssert = new SoftAssert();
        ...
        productsPage.removeFromCart(DriverContainer.getDriver(), REMOVING_FROM_CART_SAUCE_LABS_BACKPACK);
    ...
    public void testAddingToAndRemovingSeveralProductsToCart(){
        ...
        ProductsPage productsPage = signInPage.signIn(testUser);
        productsPage.addToCart(DriverContainer.getDriver(), ADDING_TO_CART_SAUCE_LABS_BACKPACK);
        productsPage.addToCart(DriverContainer.getDriver(), "add-to-cart-sauce-labs-onesie");
        ShoppingCartBadge shoppingCartBadge = new ShoppingCartBadge(DriverContainer.getDriver());
        ShoppingCart shoppingCart = shoppingCartBadge.openShoppingCart();
        shoppingCart.removeFromCart(DriverContainer.getDriver(), REMOVING_FROM_CART_SAUCE_LABS_BACKPACK);
        SoftAssert softAssert = new SoftAssert();
        ...
        softAssert.assertEquals(shoppingCart.findElementTextById(DriverContainer.getDriver(), "item_2_title_link"), SAUCE_LABS_ONESIE);
        softAssert.assertEquals(Integer.parseInt(shoppingCart.findElementTextByCssSelector(DriverContainer.getDriver(), FINDING_QUANTITY_OF_SINGLE_PRODUCT_IN_CART)),
                1,
                String.format("The quantity of the product %s in the cart is displayed incorrectly. Should be 1.", SAUCE_LABS_ONESIE));
        softAssert.assertEquals(shoppingCart.findElementTextByClassName(DriverContainer.getDriver(), FINDING_PRICE_OF_SINGLE_PRODUCT_IN_CART),
        ...
        shoppingCart.removeFromCart(DriverContainer.getDriver(), "remove-sauce-labs-onesie");
